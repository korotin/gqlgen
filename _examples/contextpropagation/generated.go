...
func (ec *executionContext) childFields_TodoContext(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	switch field.Name {
	case "value":
...
func (ec *executionContext) _Query_testTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_testTodo(ctx, field)
		},
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Todo) graphql.Marshaler {
			return ec.marshalNTodo2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋcontextpropagationᚐTodo(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _Todo_context(ctx context.Context, field graphql.CollectedField, obj *Todo) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		func(ctx context.Context, selections ast.SelectionSet, v *TodoContext) graphql.Marshaler {
			return ec.marshalNTodoContext2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋcontextpropagationᚐTodoContext(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) fieldContext_Todo_context(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		IsResolver: false,
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.childFields_TodoContext(ctx, field)
		},
	}
	return fc, nil
}
...
func (ec *executionContext) fieldContext_TodoContext_value(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("TodoContext", field, true, true, errors.New("field of type String does not have child fields"))
}
