...
func (ec *executionContext) dir_hasRole_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "role",
		func(ctx context.Context, v any) (Role, error) {
			return ec.unmarshalNRole2githubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐRole(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_MyMutation_createTodo_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg0, err := graphql.ProcessArgField(ctx, rawArgs, "todo",
		func(ctx context.Context, v any) (TodoInput, error) {
			return ec.unmarshalNTodoInput2githubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodoInput(ctx, v)
		})
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) _MyMutation_createTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Todo) graphql.Marshaler {
			return ec.marshalNTodo2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodo(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) _MyMutation_updateTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_MyMutation_updateTodo(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
		...
		func(ctx context.Context, selections ast.SelectionSet, v *Todo) graphql.Marshaler {
			return ec.marshalOTodo2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodo(ctx, selections, v)
		},
		true,
		false,
	)
...
func (ec *executionContext) _MyQuery_lastTodo(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_MyQuery_lastTodo(ctx, field)
		},
		func(ctx context.Context) (any, error) {
...
func (ec *executionContext) _MyQuery_todos(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []*Todo) graphql.Marshaler {
			return ec.marshalNTodo2ᚕᚖgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋtodoᚐTodoᚄ(ctx, selections, v)
		},
		true,
		true,
	)
