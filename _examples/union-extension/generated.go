...
func (ec *executionContext) _Like_from(ctx context.Context, field graphql.CollectedField, obj *Like) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Like_from(ctx, field)
		},
...
func (ec *executionContext) _Query_events(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, selections ast.SelectionSet, v []Event) graphql.Marshaler {
			return ec.marshalNEvent2ᚕgithubᚗcomᚋ99designsᚋgqlgenᚋ_examplesᚋunionᚑextensionᚐEventᚄ(ctx, selections, v)
		},
		true,
		true,
	)
...
func (ec *executionContext) fieldContext_Query_events(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("Query", field, true, true, errors.New("field of type Event does not have child fields"))
}
...
func (ec *executionContext) _Query_cachedEvents(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		field,
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Query_cachedEvents(ctx, field)
		},
		func(ctx context.Context) (any, error) {
